...
public:
    ...
    static Move ToMove(Board board, int from, int to, int heldPiece);

    static void GeneratePawnMoves(int pieces[], int square, int colorToMove, std::vector<Move> &pseudoLegalMoves, int pawnTwoSquareFile);
    ...
    static bool IsOutOfBounds(int oldSquare, int deltaRank, int deltaFile);
